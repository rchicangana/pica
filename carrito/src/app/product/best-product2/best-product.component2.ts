...
@Component({
  selector: "app-best-product2",
  templateUrl: "./best-product.component2.html",
  styleUrls: ["./best-product.component2.scss"]
})
export class BestProductComponent2 implements OnInit {
  bestProducts: Top5[] = [];
  options: any;
